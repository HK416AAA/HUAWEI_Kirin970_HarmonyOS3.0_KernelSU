...
@@ -367,11 +367,22 @@ static int input_get_disposition(struct input_dev *dev,
	return disposition;
}
...
fs/exec.c
@@ -1696,6 +1696,14 @@ static int exec_binprm(struct linux_binprm *bprm)
	return ret;
}
 ...
 */
@@ -1710,6 +1718,13 @@ static int do_execveat_common(int fd, struct filename *filename,
